...
class SetMgr {
public:
    SetMgr(VulkanMgr &master, int maxSet, uint32_t maxUniformSet = 0, uint32_t maxTextureSet = 0, uint32_t maxStorageBufferSet = 0, uint32_t maxStorageImageSet = 0, bool temporarySets = false, uint32_t maxDynamicUniformSet = 0);
    ~SetMgr();
